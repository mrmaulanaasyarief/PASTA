            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <?php 
                            ...
                            ?><a href="#" class="btn btn-success pull-right disabled" tabindex="-1" role="button" aria-disabled="true" style="margin-right: 5px;"><i class="fa fa-credit-card"></i> Menunggu Konfirmasi</a><?php
                        }
                    }
                    ?>
                    <?php if($pemesanan['status_pemesanan'] == 0){ ?>
