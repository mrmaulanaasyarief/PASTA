        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">Pasta</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">Pasta</span>
                </a>
                        ...
                        <!-- User Account: style can be found in dropdown.less -->
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <p>
                                    <?=$this->session->userdata('user_name')?> - Admin
                                        <small><?=$this->session->userdata('user_email')?></small>
                                    </p>
                                    </li>
                                    <!-- Menu Footer-->
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            ...
                            <ul class="treeview-menu">
                                <li>
                                    <a href="<?php echo site_url('barang/index');?>"><i class="fa fa-list-ul"></i> Lihat Barang</a>
                                </li>
								<li class="active">
                                    <a href="<?php echo site_url('barang/aksiTambahBarang');?>"><i class="fa fa-plus"></i> Tambah Barang</a>
                                </li>
							</ul>
                        </li>
						<li>
						...
						<li>
                            ...
                            <ul class="treeview-menu">
                                <li>
                                    <a href="<?php echo site_url('user/index');?>"><i class="fa fa-list-ul"></i> Lihat User</a>
                                </li>
								<li class="active">
                                    <a href="<?php echo site_url('user/aksiTambahUSer');?>"><i class="fa fa-plus"></i> Tambah User</a>
                                </li>
							</ul>
                        </li>
                    </ul>
