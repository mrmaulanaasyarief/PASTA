    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Pemesanan Edit</h3>
            </div>
			<?php echo form_open('pemesanan/edit/'.$pemesanan['id_pemesanan']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_user" class="form-control">
								...
								{
									$selected = ($user['id_user'] == $pemesanan['id_user']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="status_pemesanan" class="form-control">
								...
								{
									$selected = ($value == $pemesanan['status_pemesanan']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="total_item" value="<?php echo ($this->input->post('total_item') ? $this->input->post('total_item') : $pemesanan['total_item']); ?>" class="form-control" id="total_item" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="total_harga" class="control-label">Total Harga</label>
						<div class="form-group">
							<input type="text" name="total_harga" value="<?php echo ($this->input->post('total_harga') ? $this->input->post('total_harga') : $pemesanan['total_harga']); ?>" class="form-control" id="total_harga" />
						</div>
					</div>
				</div>
			</div>
