    ...
    <div class="col-md-12">
		<a href="<?php echo site_url('pembayaran/index'); ?>" class="btn btn-secondary"><i class="fa fa-angle-left"></i> Kembali</a>
      	<div class="box box-info">
			...
			<?php echo form_open('pembayaran/aksiEditPembayaran/'.$pembayaran['id_pembayaran']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="jenis_pembayaran" class="form-control">
								...
								{
									$selected = ($value == $pembayaran['jenis_pembayaran']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="status_pembayaran" class="form-control">
								...
								{
									$selected = ($value == $pembayaran['status_pembayaran']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_pemesanan" class="form-control">
								...
								{
									$selected = ($pemesanan['id_pemesanan'] == $pembayaran['id_pemesanan']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tanggal_pembayaran" value="<?php echo ($this->input->post('tanggal_pembayaran') ? $this->input->post('tanggal_pembayaran') : $pembayaran['tanggal_pembayaran']); ?>" class="has-datetimepicker form-control" id="tanggal_pembayaran" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="bukti_pembayaran" class="control-label">Bukti Pembayaran</label>
						<div class="form-group">
							<input type="text" name="bukti_pembayaran" value="<?php echo ($this->input->post('bukti_pembayaran') ? $this->input->post('bukti_pembayaran') : $pembayaran['bukti_pembayaran']); ?>" class="form-control" id="bukti_pembayaran" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="keterangan" class="control-label">Keterangan</label>
						<div class="form-group">
							<input type="text" name="keterangan" value="<?php echo ($this->input->post('keterangan') ? $this->input->post('keterangan') : $pembayaran['keterangan']); ?>" class="form-control" id="keterangan" />
						</div>
					</div>
				</div>
			</div>
